...
indata = """1919	2959	82	507	3219	239	3494	1440	3107	259	3544	683	207	562	276	2963
...
for row in rows:
    row_list = [int(nr) for nr in row.split('\t')]
...
for row in rows:
    row_list = [int(nr) for nr in row.split('\t')]
    for i, nr in enumerate(row_list):
        for j, k in enumerate(row_list):
            if i==j:
                continue
